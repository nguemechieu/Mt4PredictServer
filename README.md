...
> Real-time AI prediction and automation server for MetaTrader 4/5  
> Built by **Noel Martial Nguemechieu** — integrating deep learning, GPT reasoning, and automated trade management.

---

## 🚀 Overview

**Mt4PredictServer** connects MetaTrader 4/5 (via a C++ DLL bridge) to a Python AI backend.  
It streams market data, indicators, and trade events to a prediction engine (TensorFlow/Keras or GPT-based).  
The server responds with precise trade signals and real-time analysis — displayed directly inside MT4.
...
**MIT License**
Copyright © 2006 – 2025
Refactored and maintained by **Noel Martial Nguemechieu**
